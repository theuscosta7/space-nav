O projeto Space Nav é um simulador de navegação espacial. O ambiente consiste em um setor espacial representado por uma grade de 20x20.
Missão da IA

A Inteligência Artificial atua como o sistema de navegação de um foguete, sendo responsável por calcular e traçar automaticamente uma rota entre um ponto de partida e um ponto de destino.
